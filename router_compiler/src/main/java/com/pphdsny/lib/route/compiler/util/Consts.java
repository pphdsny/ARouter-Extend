...
public class Consts {
    ...
    //
    public static final String WARNING_TIPS = "DO NOT EDIT THIS FILE!!! IT WAS GENERATED BY DR-ROUTER.";
    public static final String PACKAGE_OF_GENERATE_FILE = "com.rabbit.doctor.routes";
    public static final String PACKAGE_OF_GENERATE_DOCS = "com.rabbit.doctor.routes.docs";
    ...
    public static final String ROUTER_MANAGER = "com.alibaba.android.arouter.launcher.ARouter";

    //特殊DESC
    public static final String ALONE_DESC = "ALONE";
